...
<div class="row mt-4">
   <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-10 col-sm-12 col-12 offset-xxl-2 offset-xl-2 offset-lg-2 offset-md-1 offset-sm-0">
		...
		<div class="row rows-2">
			<div class="col">
				<div id="smarty" onclick="location.href=global.url + '?do=smarty'" class="box rounded shadow d-flex justify-content-center align-items-center flex-column py-5">
					<i class="bi bi-hdd-rack"></i>
					<span class="text-white text-uppercase">Actualizar Smarty</span>
				</div>
			</div>
			<div class="col">
				<div id="jquery" onclick="location.href=global.url + '?do=jquery'" class="box rounded shadow d-flex justify-content-center align-items-center flex-column py-5">
