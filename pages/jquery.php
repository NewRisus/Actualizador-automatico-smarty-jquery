...
<?php if(!$upgrade): ?>
   <div id="upgrade" class="col-xxl-10 col-xl-10 col-lg-10 col-md-8 col-sm-12 col-12 offset-xxl-2 offset-xl-2 offset-lg-2 offset-md-2 offset-sm-0"></div>
	<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-10 col-sm-12 col-12 offset-xxl-2 offset-xl-2 offset-lg-2 offset-md-1 offset-sm-0" id="hide">
		<div class="hidden">
			<p class="text-muted">Este actualizador de archivos .js lograr&aacute; actualizar todas las funciones obsoletas de <b>Phpost Risus 1.x</b> y <b>New Risus 1.x</b>, lograr&aacute; actualizarlas a las m&aacute;s recientes y disponibles que existan al momento para <b id="vjs"></b>.</p>
